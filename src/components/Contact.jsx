            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4">
              <div className="flex-1 flex flex-col gap-2 text-sm font-bold text-white/90">
                ...
                <div className="flex flex-wrap gap-4 mt-4">
                  <a href="https://www.linkedin.com/in/maniarasan-j-175780248/" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://github.com/Mani2815" target="_blank" rel="noopener noreferrer"
                    className="group flex items-center gap-1.5 text-white/70 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest underline underline-offset-2">
                  ...
                  <a href="https://hackerrank.com/maniarasan2815" target="_blank" rel="noopener noreferrer"
                    className="group flex items-center gap-1.5 text-white/70 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest underline underline-offset-2">
                    <img src="https://cdn.simpleicons.org/hackerrank" alt="HackerRank" className="w-4 h-4 hover:scale-110 transition-transform" />
                    HackerRank
                  </a>
                  <a href="https://leetcode.com/u/mani2815/" target="_blank" rel="noopener noreferrer"
                    className="group flex items-center gap-1.5 text-white/70 hover:text-white transition-colors text-xs font-bold uppercase tracking-widest underline underline-offset-2">
                    <img src="https://cdn.simpleicons.org/leetcode" alt="LeetCode" className="w-4 h-4 hover:scale-110 transition-transform" />
                    LeetCode
                  </a>
                </div>
              </div>
